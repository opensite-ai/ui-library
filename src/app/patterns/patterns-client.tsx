 ...
 * Client-side logic for pattern preview with interactive controls
 */

import { useEffect, useState } from "react";
import { Section } from "@opensite/ui";
import type { SectionBackground } from "@opensite/ui/types";
import type { PatternName } from "../api/patterns/route";
      ...
      <div className="relative w-full" style={{ aspectRatio: "19 / 6" }}>
        ...
        >
          <div className="flex h-full items-center justify-center">
            <span className="font-mono text-xs opacity-50">{pattern}</span>
          </div>
        </Section>
      </div>
...
export function PatternsClient() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Section
        spacing="lg"
        className="relative bg-background text-foreground py-8 md:py-16 border-b border-border"
      >
        <div className="space-y-4">
          <div>
            <h1 className="text-3xl font-bold md:text-4xl">Pattern Library</h1>
